  ...
  return (
    <header className="fixed bottom-0 start-0 end-0 z-40 px-4 pb-6 pointer-events-none">
      <nav className="mx-auto max-w-fit pointer-events-auto">
        <div className="bg-gray-900/80 backdrop-blur-2xl rounded-full px-6 py-3 shadow-2xl border border-white/10 hover:border-orange-500/20 transition-colors duration-500">
            ...
            {navItems.map(({ icon: Icon, href, label }) => {
              ...
              return (
                <li key={href} className="relative group">
                  <a
                    ...
                    className={`
                      ...
                      ${isActive 
                        ...
                        : 'text-slate-300 hover:text-orange-400 hover:bg-gray-800/50'
                      }
                  ...
                  {isActive && (
                    <span className="absolute inset-0 rounded-full bg-orange-500/20 blur-md animate-pulse"></span>
                  )}
                </li>
              );
            })}
