        ...
        <section className="w-full bg-gradient-to-b from-black via-gray-900/50 to-black py-20" id="work">
            ...
            <div className="w-full px-6 max-w-7xl mx-auto">
                ...
                <div className="text-center mb-16">
                    <div className="inline-flex items-center gap-2 px-4 py-2 bg-orange-500/10 
                                  border border-orange-500/20 rounded-full mb-6 backdrop-blur-sm">
                    ...
                    <h2 className="text-5xl md:text-6xl lg:text-7xl font-bold mb-6">
                        <span className="bg-gradient-to-r from-orange-400 via-orange-600 to-orange-800 
                            ...
                            <div className="text-center">
                                <button
                                    ...
                                    className="px-8 py-4 bg-white/5 hover:bg-white/10 border border-white/10 
                                             hover:border-orange-500/50 text-white font-medium rounded-xl 
                                             backdrop-blur-sm transition-all duration-300 hover:scale-105
                                             hover:shadow-lg hover:shadow-orange-500/20 flex items-center gap-3 mx-auto"
                                >
                                    Load More Projects
